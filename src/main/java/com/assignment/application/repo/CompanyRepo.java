...
public interface CompanyRepo extends JpaRepository<Company, Long> {
    ...
    @Query(value = "Select new com.assignment.application.entity.CompleteCompInfo(emp.name as employeeName,emp.employeeId as employeeId,comp.id as companyId,deptList.departmentName as departmentName," +
    ...
    Page<CompleteCompInfo> getCompanyCompleteInfo(Long companyId, Pageable pageable);
